...
<div class="row">
    <div class="col-md-offset-1 col-md-10">
        <h1><i class="fa fa-user" aria-hidden="true"></i></span> Client: Name Here</h1>

        <table class="table-striped lead">
            <tr>
                <th class="th">ID</th>
                <td>123456789</td>
            </tr>
            ...
            <tr>
                <th class="th">Address 1:</th>
                <td>Kuzne4nay str</td>
            </tr>
            <tr>
                <th class="th">Addres 2:</th>
